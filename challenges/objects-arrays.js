...
function sortUniversities(graduates){
const universities = [];
for (let i = 0; i < graduates.length; i++){
  universities.push(graduates[i]);
}
universities.sort((a, b) =>
a.university > b.university ? 1 : b.university > a.university ? -1 : 0
);
return universities;
}
...
*/
function population (zooAnimals){
const populationTotal = 0;
const reduceStatePopulations = zooAnimals.reduce((total, zooAnimals) => {
